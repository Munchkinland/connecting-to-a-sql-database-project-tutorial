...
query_book_authors = "SELECT * FROM book_authors"

# Use pandas to read data from each table into a dataframe
...
df_book_authors = pd.read_sql(query_book_authors, con=engine)
